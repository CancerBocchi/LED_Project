...
{   
        ...
        //DrawString(10,10,"STR",1);
        DrawLine(0,15,125,15);
        DrawLine(90,0,90,70);

        DrawString(95,5,"LED",1);

        DrawLine(90,27,125,27);
        DrawLine(90,39,125,39);
        DrawLine(90,52,125,52);
        DrawLine(0,63,125,63);
        
        DrawString(0,17,"TimeSet:",1);
        DrawString(0,27,"Start_Time:",1);
        DrawString(0,43,"End_Time:",1);

        if(LED_State_Flag[0])
            DrawString(95,17,"1:ON",1);
        else
            DrawString(95,17,"1:OFF",1);

        if(LED_State_Flag[1])
            DrawString(95,29,"2:ON",1);
        else
            DrawString(95,29,"2:OFF",1);

        if(LED_State_Flag[2])
            DrawString(95,41,"3:ON",1);
        else
            DrawString(95,41,"3:OFF",1);

        if(LED_State_Flag[3])
            DrawString(95,54,"4:ON",1);
        else
            DrawString(95,54,"4:OFF",1);
